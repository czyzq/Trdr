...
export const TradesTab: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full p-2 md:p-4 gap-2 md:gap-3 overflow-auto">
      {/* Stats Bar */}
      <div className="flex flex-wrap items-center gap-2 md:gap-4 px-3 md:px-4 py-2 md:py-3 rounded-sm"
        ...
        <div className="flex items-center gap-2 ml-auto">
          <span className="text-[10px] uppercase tracking-wider hidden sm:inline" style={{ color: "#4a5568" }}>
            Total P&L:
          </span>
