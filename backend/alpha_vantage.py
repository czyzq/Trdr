...
class AsyncAlphaVantageClient:
    ...
    async def get_candles(
        ...
        try:
            ...
            params = {"function": function, "symbol": av_symbol, "apikey": self.api_key}
    ...
    def get_quote(self, symbol: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if loop.is_running():
                ...
                future = asyncio.run_coroutine_threadsafe(self._async_client.get_quote(symbol), loop)
    ...
    def get_candles(self, symbol: str, resolution: str = "60", count: int = 100):
        ...
        try:
            ...
            if loop.is_running():
                ...
                return loop.run_until_complete(self._async_client.get_candles(symbol, resolution, count))
        except Exception as e:
